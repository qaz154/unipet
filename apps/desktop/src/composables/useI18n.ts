...
const en = {
  ...
  'settings.voiceCompanion': 'Voice Companion',
  'settings.voiceCompanionDesc': 'Talk to your pet, get voice responses',
  'settings.emotionMusic': 'Emotion Music',
  'settings.emotionMusicDesc': 'Ambient music follows pet mood',
...
const zh: LocaleMessages = {
  ...
  'settings.about': '关于',
  'settings.voiceCompanion': '语音伙伴',
  'settings.voiceCompanionDesc': '对宠物说话，获得语音回复',
  'settings.emotionMusic': '情感音乐',
  'settings.emotionMusicDesc': '环境音乐随宠物心情变化',
...
const ja: LocaleMessages = {
  ...
  'settings.about': 'について',
  'settings.voiceCompanion': 'ボイスコンパニオン',
  'settings.voiceCompanionDesc': 'ペットと会話して、音声で返答を受けましょう',
  'settings.emotionMusic': '感情音楽',
  'settings.emotionMusicDesc': 'ペットの気分に合わせてアンビエント音楽を再生',
...
const ko: LocaleMessages = {
  ...
  'settings.about': '정보',
  'settings.voiceCompanion': '보이스 컴패니언',
  'settings.voiceCompanionDesc': '펫과 대화하고 응답을 받아보세요',
  'settings.emotionMusic': '감정 음악',
  'settings.emotionMusicDesc': '펫의 기분에 맞춰 앰비언트 음악을 재생합니다',
...
const zhTw: LocaleMessages = {
  ...
  'settings.about': '關於',
  'settings.voiceCompanion': '語音夥伴',
  'settings.voiceCompanionDesc': '和寵物對話，獲得語音回覆',
  'settings.emotionMusic': '情感音樂',
  'settings.emotionMusicDesc': '環境音樂隨寵物心情變化',
